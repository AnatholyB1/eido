...
export default function Navbar({  className,children, ...props }: NavbarProps) {
    return (
        <div className={cn( 'flex flex-row items-center justify-between sm:justify-end w-full h-[5rem] border-b shadow-sm fixed bg-white/95 py-2 px-6',className )} {...props}>
