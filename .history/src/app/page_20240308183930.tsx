                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input className='flex items-start w-auto' type={item.type} disabled={item.disabled}  {...field} value={item.type == 'checkbox' ? item.name : item.type == 'number' ? field.value as number : field.value as string} />
                      </FormControl>
                      <FormDescription>
                        {item.description}
                      </FormDescription>
